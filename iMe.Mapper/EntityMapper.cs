    ...
    public class PersonalInfoProfile : Profile
    {
        public PersonalInfoProfile()
        {
            this.CreateMap<User, SocialClientResponse>()
                ...
                .ForMember(dest => dest.Bio, opts => opts.MapFrom(src => src.Description));
            ...
            this.CreateMap<GitHubUserResponse, SocialClientResponse>()
                ...
                .ForMember(dest => dest.Bio, opts => opts.MapFrom(src => src.Bio));

            this.CreateMap<SocialClientResponse, PersonalInfoDto>();
        }
    }
}